 ...
 *
 */
@ApiModel(description = "Hello请求报文")
public class HelloRequest {
	...
	public HelloRequest(String helloName, BigDecimal helloAmount, Boolean helloIndication, List<String> helloStringList, Map<String, String> helloStringMap) {
	...
	public HelloRequest setHelloName(String helloName) {
		this.helloName = helloName;
		return this;
	}
	...
	public HelloRequest setHelloAmount(BigDecimal helloAmount) {
		this.helloAmount = helloAmount;
		return this;
	}
	...
	public HelloRequest setHelloIndication(Boolean helloIndication) {
		this.helloIndication = helloIndication;
		return this;
	}
	...
	public HelloRequest setHelloStringList(List<String> helloStringList) {
		this.helloStringList = helloStringList;
		return this;
	}
	...
	public HelloRequest setHelloStringMap(Map<String, String> helloStringMap) {
		this.helloStringMap = helloStringMap;
		return this;
	}
